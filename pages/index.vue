      ...
      <nav class="sticky top-0 bg-white shadow-md z-10">
        ...
        >
          ...
          <div
            ...
            class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white md:bg-transparent md: md:mt-0 md:p-0 md:top-0 md:relative md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center shadow-xl"
          >
          ...
          <div class="items-center flex h-full flex-col lg:flex-row">
            <div class="flex-1 flex flex-col justify-center">
              <div class="">
                ...
                >
                  Scan<span class="text-green-500">Eating</span>
                </h1>
